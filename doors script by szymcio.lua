...
local Window = OrionLib:MakeWindow({IntroText = "Doors GUI v1.2 By Szymcio",Name = "Doors", HidePremium = false, SaveConfig = true, ConfigFolder = "DoorsSex"})
...
CreditsTab:AddParagraph("Credits to","Szymcio - (Got most of the ideas from their head, check him out! - https://www.roblox.com/users/3730072604/profile/)")
